...
추가 사용자 확인에 따라 모두의창업 준비자·사주앱·디지털노마드는 `/landing` 검색·공유 설명문에서 개발 상담 대상으로 반영했다. 모두의창업 미수행 확인은 유지하며 공식 관계를 주장하지 않는다. 정부지원사업은 회사소개에 공개된 예비창업패키지 수료 연혁의 요약이다. 기존 흐름으로 배포 후 최초 HTML과 실제 검색 노출을 구분해 확인한다. [최신 작업·검증·롤백](service-context-update.md)을 확인한다.
